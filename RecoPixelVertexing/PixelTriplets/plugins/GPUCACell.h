...
public:
  ...
  __device__ inline bool hole0(HitsConstView hh, GPUCACellT const& innerCell) const {
  ...
  __device__ inline bool hole4(HitsConstView hh, GPUCACellT const& innerCell) const {
    using namespace phase1PixelTopology;
