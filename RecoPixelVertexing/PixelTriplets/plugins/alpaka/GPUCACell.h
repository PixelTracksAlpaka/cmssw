...
namespace ALPAKA_ACCELERATOR_NAMESPACE {
  ...
  public:
    ...
    ALPAKA_FN_ACC ALPAKA_FN_INLINE bool hole0(const HitsConstView& hh, GPUCACellT const& innerCell) const {
    ...
    ALPAKA_FN_ACC ALPAKA_FN_INLINE bool hole4(const HitsConstView& hh, GPUCACellT const& innerCell) const {
      using namespace phase1PixelTopology;
