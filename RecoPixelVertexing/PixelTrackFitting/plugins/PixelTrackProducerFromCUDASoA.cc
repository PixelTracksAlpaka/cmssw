...
class PixelTrackProducerFromCUDASoAT : public edm::global::EDProducer<> {
...
public:
  ...
  explicit PixelTrackProducerFromCUDASoAT(const edm::ParameterSet &iConfig);
  ~PixelTrackProducerFromCUDASoAT() override = default;
...
template <typename TrackerTraits>
PixelTrackProducerFromCUDASoAT<TrackerTraits>::PixelTrackProducerFromCUDASoAT(const edm::ParameterSet &iConfig)
...
template <typename TrackerTraits>
void PixelTrackProducerFromCUDASoAT<TrackerTraits>::fillDescriptions(edm::ConfigurationDescriptions &descriptions) {
...
template <typename TrackerTraits>
void PixelTrackProducerFromCUDASoAT<TrackerTraits>::produce(edm::StreamID streamID,
                                                        edm::Event &iEvent,
...
using PixelTrackProducerFromCUDASoAPhase1 = PixelTrackProducerFromCUDASoAT<pixelTopology::Phase1>;
DEFINE_FWK_MODULE(PixelTrackProducerFromCUDASoAPhase1);

using PixelTrackProducerFromCUDASoAPhase2 = PixelTrackProducerFromCUDASoAT<pixelTopology::Phase2>;
DEFINE_FWK_MODULE(PixelTrackProducerFromCUDASoAPhase2);
