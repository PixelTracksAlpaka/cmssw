#ifndef CalibTracker_SiPixelESProducers_interface_alpaka_SiPixelMappingDevice_h
#define CalibTracker_SiPixelESProducers_interface_alpaka_SiPixelMappingDevice_h
...
namespace cms::alpakatools {
  template <>
  struct CopyToHost<ALPAKA_ACCELERATOR_NAMESPACE::SiPixelMappingDevice> {
    template <typename TQueue>
    static auto copyAsync(TQueue& queue, ALPAKA_ACCELERATOR_NAMESPACE::SiPixelMappingDevice const& deviceData) {
