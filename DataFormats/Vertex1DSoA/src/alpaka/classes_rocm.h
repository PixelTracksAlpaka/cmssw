#ifndef DataFormats_Vertex1DSoA_src_alpaka_classes_rocm_h
#define DataFormats_Vertex1DSoA_src_alpaka_classes_rocm_h
...
#endif  // DataFormats_Vertex1DSoA_src_alpaka_classes_rocm_h
