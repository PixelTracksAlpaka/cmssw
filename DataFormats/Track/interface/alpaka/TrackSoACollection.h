#ifndef DataFormats_Track_alpaka_TrackSoACollection_H
#define DataFormats_Track_alpaka_TrackSoACollection_H
...
namespace ALPAKA_ACCELERATOR_NAMESPACE {
  ...
  namespace pixelTrack {
    using TrackSoAPhase1 = TrackSoACollection<pixelTopology::Phase1>;
    using TrackSoAPhase2 = TrackSoACollection<pixelTopology::Phase2>;
  }  // namespace pixelTrack
...
//     using TrackSoADevicePhase1 = TrackSoADevice<Device, pixelTopology::Phase1>;
//     using TrackSoADevicePhase2 = TrackSoADevice<Device, pixelTopology::Phase2>;
...
namespace cms::alpakatools {
  ...
  template <>
  struct CopyToHost<ALPAKA_ACCELERATOR_NAMESPACE::pixelTrack::TrackSoAPhase1> {
    template <typename TQueue>
    static auto copyAsync(TQueue& queue, ALPAKA_ACCELERATOR_NAMESPACE::pixelTrack::TrackSoAPhase1 const& deviceData) {
  ...
  template <>
  struct CopyToHost<ALPAKA_ACCELERATOR_NAMESPACE::pixelTrack::TrackSoAPhase2> {
    template <typename TQueue>
    static auto copyAsync(TQueue& queue, ALPAKA_ACCELERATOR_NAMESPACE::pixelTrack::TrackSoAPhase2 const& deviceData) {
