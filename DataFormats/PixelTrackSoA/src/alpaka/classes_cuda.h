...
#ifndef DataFormats_PixelTrackSoA_src_alpaka_classes_cuda_h
#define DataFormats_PixelTrackSoA_src_alpaka_classes_cuda_h
...
#endif  // DataFormats_PixelTrackSoA_src_alpaka_classes_cuda_h
