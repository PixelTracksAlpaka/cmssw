...
using SiPixelClustersCUDALayout = SiPixelClustersCUDATemplate<>;
using SiPixelClustersCUDAView = SiPixelClustersCUDALayout::View;
using SiPixelClustersCUDAConstView = SiPixelClustersCUDALayout::ConstView;


// Decorating the Portable collection to add previously existing functions
class SiPixelClustersCUDA : public PortableCUDADeviceCollection<SiPixelClustersCUDALayout> {
public:
  SiPixelClustersCUDA() = default;
  explicit SiPixelClustersCUDA(size_t maxModules, cudaStream_t stream)
      : PortableCUDADeviceCollection<SiPixelClustersCUDALayout>(maxModules + 1, stream) {}
