...
class TrackingRecHitSoAHost : public cms::cuda::PortableHostCollection<HitLayout<TrackerTraits>> {
public:
  ...
  using cms::cuda::PortableHostCollection<HitLayout<TrackerTraits>>::buffer;
  using cms::cuda::PortableHostCollection<HitLayout<TrackerTraits>>::bufferSize;
